$(document).ready(function(){
	...
	jQuery(".slideBox").slide({mainCell:".bd ul",autoPlay:true,effect:"leftLoop",delayTime:700});
	/*首页幻灯片*/
	...
	jQuery(".newsScroll-left").slide({titCell:".hd ul",mainCell:".bd ul",autoPage:true,effect:"leftLoop",autoPlay:true,vis:2});
	/*新闻滚动*/
});